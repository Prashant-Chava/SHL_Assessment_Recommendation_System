...
st.set_page_config(page_title="Smart SHL Assessment Recommender", layout="centered")

st.markdown(
    """
    <h1 style='text-align: center; color: #4B8BBE;'>🧠 Smart SHL Assessment Recommender</h1>
    <h4 style='text-align: center; color: #ccc;'>Find the best assessments based on your query using AI!</h4>
    <hr style="border: 1px solid #333;">
    """,
    unsafe_allow_html=True
)
query = st.text_input("🔍 Paste job description or skills you want to assess:", placeholder="e.g. Python developer, SQL skills, Communication test")
