...
def startup_event():
    ...
    print("🚀 Initializing SHL Recommender backend...")
    ...
    catalog_df['combined'] = catalog_df.apply(merge_catalog_columns, axis=1)
    corpus = catalog_df['combined'].tolist()
    corpus_embeddings = model.encode(corpus, convert_to_tensor=True)
    print("✅ Backend initialization complete. Ready to recommend assessments.")
